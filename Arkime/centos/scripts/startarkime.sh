...
echo $ES_HOST
echo $ES_PORT
#curl -sSk "https://elastic:Sovereign78Z@$ES_HOST:$ES_PORT/_cluster/health?wait_for_status=green"
#until curl -sSk "https://elastic:Sovereign78Z@$192.168.100.5:9200/_cluster/health?wait_for_status=green" > /dev/null 2>&1
#do
